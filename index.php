...
?>
	...
	<div id="hero">
        ...
        <div class="call-to-action group">
            ...
            <a id="to_contactus" href="contact.html" class="btn btn-kh">Contact Us</a>
        </div>
    </div> <!-- /#hero -->
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6">
                        ...
                        <p>Our team here at KH Squared RIA will assist your firm in the process of registration in the jurisdiction in which you operate. We will provide guidance throughout the entire process from the initial planning up to the time when your firm is approved to operate. Our understanding of regulatory and compliance laws within the industry will allow us to work diligently without compromising efficiency.<br>
                        Our services will include the following:<br></p>
                        <ol>
                            <li>Finra initial filing</li>
                            <li>Complete all required regulatory forms.</li>
                            <li>Register the primary representative of your firm.</li>
                            <li>Create custom documents that your firm is required to maintain.</li>
                            <li>Provide 3 months of additional assistance for follow up questions or for required amendments to any forms.</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-6 right-col">
                        ...
                        <p>Additional fees apply for the registration of additional individual representatives &#40;$200&#41; and registering the firm in additional jurisdictions &#40;$400 per&#41;. FINRA filing fees, and exam fees are not included in the price above and go directly to the agencies.</p>
                    </div> <!-- /.twelve columns -->
                </div> <!-- /.row -->
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <img class="img-responsive" src="img/portraits/koob_her-port.jpg" alt="Portrait of Koobmeng Her">

                                <h4>President &amp; Chief Operating Officer</h4>
                            ...
                            <div class="col-sm-6">
                                ...
                                <img class="img-responsive" src="img/portraits/kee_her-port.jpg" alt="Portrait of Koobmeng Her">
